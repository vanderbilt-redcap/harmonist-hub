    ...
    <div class="optionSelect">
        <div style="margin: 0 auto;width: 200px;">
            <?php if($isAdmin || $harmonist_perm_news){?>
                <a href="#" onclick="editIframeModal('hub_add_news','redcap-add-news','<?=APP_PATH_WEBROOT_FULL."surveys/?s=".$module->escape($pidsArray['SURVEYNEWS'])."&news_person=".$module->escape($current_user['record_id'])?>');" class="btn btn-success btn-md"><span class="fa fa-plus"></span> Add News</a>
                ...
                if(!empty($newItems)) {?>
                    ...
                    foreach ($newItems as $news) {
                        ...
                        echo '<tr>'.
                            ...
                            '<td width="13%">'.getPeopleName($pidsArray['PEOPLE'], $news['news_person'], 'email').' ('.htmlspecialchars($region_code,ENT_QUOTES).')</td>'.
                            '<td style="width: 60%">'.
