...
<div>
    <ul class="list-inline">
        <li><span class="label label-default_light" title="Not Started"><i class="fa-label-legend fa fa-times text-default_light" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="No regional activity on this request." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Not started</a></li>
        <li><span class="label label-warning" title="Partial Data"><i class="fa-label-legend fa fa-wrench" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="Your region has submitted some but not all data for this data request." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Partial Data</a></li>
        <li><span class="label label-approved" title="Complete Data"><i class="fa-label-legend fa fa-check" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="Your region has submitted a full regional dataset for this data request." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Complete Data</a></li>
        <li><span class="label label-default" title="Not Applicable Data"><i class="fa-label-legend fa fa-ban" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="Your region does not have the requested data for this project." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Data Not Available</a></li>
        <li><span class="label label-default" title="Not Applicable Region"><i class="fa-label-legend fa fa-times" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="Your region is not one of the requested regions for this project." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Region Not Requested</a></li>
        <li><span class="label label-other" title="Other Status"><i class="fa-label-legend fa fa-question" aria-hidden="true"></i></span> <a href="#" data-toggle="tooltip" title="Some other data submission or project participation status applies." data-placement="top" class="custom-tooltip" style="vertical-align: -2px;">Other Status</a></li>
    </ul>
</div>
<div class="optionSelect">
