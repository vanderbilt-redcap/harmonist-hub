...
<div class="pull-right">
    <p><a href="<?=$module->getUrl('index.php').'&NOAUTH&pid='.$pidsArray['PROJECTS'].'&option=lgd&type=upload'?>">View Data Activity Log</a> | <a href="<?=$module->getUrl('index.php')."&NOAUTH&option=pdc"?>">View Past Data Calls</a></p>
</div>
        ...
        <div class="table-responsive">
            <table class="table sortable-theme-bootstrap" data-sortable>
                ...
                if(!empty($open_data_calls)) {
                    echo getDataCallHeader($pidsArray['REGIONS'], $current_user['person_region'],$settings['vote_grid']);
