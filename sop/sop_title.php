...
if($sop !="") {
    ...
    $sop_datacontact = getProjectInfoArray($RecordSetPeople)[0];
    $data_contact = "<em>None</em>";
    if($sop_datacontact['firstname'] != ''){
        $data_contact = $sop_datacontact['firstname'] . ' ' . $sop_datacontact['lastname']." (<a href='mailto:".$sop_datacontact['email']."'>".$sop_datacontact['email']."</a>)";
    }
    ...
    if ($_REQUEST['option'] == 'und' && $_REQUEST['record'] != '') {
        ...
        if (($key = array_search($userid, $array_userid)) !== false) {
            ...
            $recordUp = array();
            $recordUp[$record_id][$event_id]['follow_activity'] = $string_userid;
            $results = \Records::saveData(IEDEA_SOP, 'array', $recordUp,'overwrite', 'YMD', 'flat', '', true, true, true, false, true, array(), true, false);
    ...
    <?php if(($sop['sop_hubuser'] == $current_user['record_id'] || $isAdmin || $sop['sop_visibility'] == '2') && $sop !="") { ?>
                ...
                <?php if ($isAdmin || $harmonist_perm) {
                    ...
                    <div class="btn-group hidden-xs pull-right">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if($sop['sop_status'] == "1" && $sop['sop_visibility'] == "2" && $sop['sop_finalize_y'][1] == '1' && empty($sop['sop_closed_y'][1])){
                        ...
                        <div class="modal-dialog" role="document" style="width: 800px;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <iframe class="commentsform" message="S" id="redcap-finalize-frame" name="redcap-finalize-frame"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-striped">
                                        ...
                                        $regions = getProjectInfoArray($RecordSetRegions)[0];
        ...
        <div class="hidden-md hidden-lg hidden-sm" style="margin-bottom: 20px">
            ...
            if (!empty($row_sop_file['doc_name'])) {
                ...
                <a class="btn btn-default" href="<?=$module->getUrl("downloadFile.php?code=".getCrypt("sname=" . $row_sop_file['stored_name'] . "&file=" . urlencode($row_sop_file['doc_name'])."&edoc=".$sop["sop_finalpdf"]."&pid=".$current_user['record_id'], 'e', $secret_key, $secret_iv)) ?>" target="_blank">
        ...
        <div class="panel panel-default hidden-xs" style="margin-bottom: 40px">
            <div class="panel-heading" style="height: 38px">
                <h3 class="panel-title">
                    ...
                    <?php
                    #Concept Files
                    $q = $module->getUrl("SELECT doc_name,stored_name,file_extension FROM redcap_edocs_metadata WHERE doc_id = ?",[$sop["sop_finalpdf"]]);
                    $row_sop_file = $q->db_fetch_assoc();
                    ...
                    if (!empty($row_sop_file['doc_name'])) {
                        ...
                        <a href="<?=$module->getUrl("downloadFile.php?code=".getCrypt("sname=" . $row_sop_file['stored_name'] . "&file=" . urlencode($row_sop_file['doc_name'])."&edoc=".$sop["sop_finalpdf"]."&pid=".$current_user['record_id'], 'e', $secret_key, $secret_iv)) ?>"
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <a href="<?=$module->geturl("index.php?option=lgd&record=".$_REQUEST['record'])?>" style="float: right;padding-right: 10px;color: #337ab7">View more</a>
                </h3>
            </div>
            <div id="collapse_dataReqUp" class="panel-collapse" aria-expanded="true">
                <table class="table table_requests sortable-theme-bootstrap" data-sortable id="sortable_table">
                    ...
                    <?php
                    $RecordSetDU = \REDCap::getData(IEDEA_DATAUPLOAD, 'array', array('data_assoc_request' => $_REQUEST['record']));
                    $uploads = getProjectInfoArray($RecordSetDU);
                    ...
                    foreach ($uploads as $up) {
                        if($settings['dataupload_dur'] > $count) {
                            $RecordSetPeopleDown = \REDCap::getData(IEDEA_PEOPLE, 'array', array('record_id' => $up['data_upload_person']));
                            $people = getProjectInfoArray($RecordSetPeopleDown)[0];
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse in" aria-expanded="true">
                <table class="table table-hover table-bordered table-list table-font-size">
                    ...
                    $RecordSetComments = REDCap::getData(IEDEA_SOPCOMMENTS, 'array', null, null, null, null, false, false, false, $parameter, false);
