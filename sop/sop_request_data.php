                ...
                <div id="collapse" class="table-responsive panel-collapse collapse in">
                    ...
                    if(!empty($sop_drafts)) {?>
                        ...
                        foreach ($sop_drafts as $draft){
                            $data .= getDataCallRow($module,$draft,$isAdmin,$current_user,$secret_key,$secret_iv,0,'p',$harmonist_perm);
                        }
                        echo $data;
                    }else{?>
                        <tbody>
            ...
            <div id="collapse" class="table-responsive panel-collapse collapse in" aria-expanded="true">
                <table class="table table_requests sortable-theme-bootstrap" data-sortable="" id="" data-sortable-initialized="true">
                    ...
                    <?php
                        $data = "";
                        foreach ($sop_drafts as $draft){
                            $data .= getDataCallRow($module,$draft,$isAdmin,$current_user,$secret_key,$secret_iv,0,'m',$harmonist_perm);
                        }
                        echo $data;
                    }else{?>
                        <tbody>
