...
<!--        var docname = --><?php //=json_encode($export_name)?>//;
...
//            <p class="hub-title"><?php //=filter_tags($settings['hub_concept_text'])?><!--</p>-->
<!--    </div>-->
<!---->
<!--    <div class="optionSelect">-->
<!--        --><?php
...
<!--                    <form method="POST" action="--><?php //=$module->getUrl('hub/hub_concepts_tracker_spreadsheet.php')?><!--" id="form_concepts_tracker">-->
...
<!--                <div style="--><?php //=$newconcept_btn_css?><!--">-->
...
<!--                                <iframe class="commentsform" id="redcap-new-frame" name="redcap-new-frame" message="N" src="--><?php //=APP_PATH_WEBROOT_FULL."surveys/?s=".$module->escape($pidsArray['CONCEPTLINK'])."&modal=modal"?><!--" style="border: none;height: 810px;width: 100%;"></iframe>-->
<!--                            </div>-->
<!---->
