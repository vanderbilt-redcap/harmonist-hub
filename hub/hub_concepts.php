                    ...
                    <div class="modal-dialog" role="document" style="width: 950px">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <iframe class="commentsform" id="redcap-new-frame" name="redcap-new-frame" message="N" src="<?=APP_PATH_WEBROOT_FULL."surveys/?s=".IEDEA_CONCEPTLINK."&modal=modal"?>" style="border: none;height: 810px;width: 100%;"></iframe>
                            </div>
