...
<div>
                    ...
                    <div class="modal-dialog" role="document" style="width: 800px">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                ?>
                                <button type="button" class="btn btn-default btn-save" onclick='save_votes(<?=json_encode($current_user['record_id'])?>,<?=json_encode($current_user['person_region'])?>,<?=json_encode($response_pi_level)?>,<?=json_encode($module->getUrl('hub/hub_request_admin_vote_AJAX.php'))?>)' data-dismiss="modal">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="upload_author_revision" tabindex="-1" role="dialog" aria-labelledby="Codes">
                    <div class="modal-dialog" role="document" style="width: 800px">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php
                                $survey_path = APP_PATH_WEBROOT_FULL."/surveys/?s=".IEDEA_SURVEYLINK."&author_revision_y=1"."&request_id=".$_REQUEST['record']."&response_person=".$current_user['record_id']."&response_region=".$current_user['person_region']."&response_pi_level=".$response_pi_level."&modal=modal";
                                ?>
    ...
    <div class="panel panel-default">
        ...
        <?php
            ...
            $survey_path = APP_PATH_WEBROOT_FULL."surveys/?s=".IEDEA_SURVEYLINK."&request_id=".$_REQUEST['record']."&response_person=".$current_user['record_id']."&response_region=".$current_user['person_region']."&response_pi_level=".$response_pi_level."&modal=modal";
        ?>
