...
<div class="modal fade" id="modal-data-download-confirmation" tabindex="-1" role="dialog" aria-labelledby="Codes">
    <form class="form-horizontal" action="index.php?option=dnd" method="post" id='dataDownloadForm'>
...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="border: none;">
                <h3 class="panel-title">
                    Data News
                    <a href="index.php?option=dna&type=1" style="float: right;padding-right: 10px;color: #337ab7">View more</a>
                </h3>
            </div>
                        ...
                        foreach($newItems as $event){
                            if($i <= 5) {
                                ...
                                echo "<td style='width: 755px;' class='media'>" .
                                    ...
                                    "<span>" . getPeopleName($event['news_person'], 'email') . " on " . $event['news_d'] ."</span>".
        ...
        <div class="panel panel-default panel-table">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <a href="index.php?option=sra" style="float: right;padding-right: 10px;color: #337ab7">View more</a>
                </h3>
            </div>
            <ul class="list-group">
                <?php
                            ...
                            if($recent_activity['comments'] != '') {
                                ...
                                if ($recent_activity['author_revision_y'] == '1') {
                                    echo '<i class="fa fa-fw fa-file-text-o text-success" aria-hidden="true"></i>' .
                                        ...
                                        '<strong>' . $name . '</strong> submitted a <strong>revision</strong> for ' . $assoc_concept.', <a href="index.php?option=sop&record=' . $recent_activity['sop_id'] . '" target="_blank">'.$title . '</a>';
                                } else{
                                    ...
                                    echo $icon.$text.' for ' . $assoc_concept.', <a href="index.php?option=sop&record=' . $recent_activity['sop_id'] . '" target="_blank">'.$title . '</a>';
                                }
                                echo '</li>';
                                $i++;
    ...
    <div class="col-sm-3">
        <div class="list-group">
            <a href="index.php?option=lgd" style="cursor:pointer" class="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <a href="index.php?option=tbl" class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1">
            ...
            <a href="index.php?option=mth" class="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <?php } ?>
            <a href="index.php?option=ofs" class="list-group-item list-group-item-action flex-column align-items-start">
                <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1">
