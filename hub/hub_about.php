...
$about = getProjectInfoArrayRepeatingInstruments($RecordSetAbout)[0];
?>
...
<div class="container">
    <div class="row">
        ...
        foreach ($about['about_firstname'] as $id=>$member){
            ...
            '<div class="thumbnail">'.
                '<img src="'.getFile($module,$about['about_photo'][$id],'src').'" alt="'.$about['about_firstname'][$id].' '.$about['about_lastname'][$id].'" class="about_portrait">'.
