...
<div>
    <div class="panel-collapse collapse in" aria-expanded="true">
        <div class="panel-body">
            <iframe class="commentsform" id="redcap-frame" message="R" src="https://redcap.vanderbilt.edu/surveys/?s=3RKCREXK7R" style="border: none;height: 860px;width: 100%;"></iframe>
        </div>
    </div>
</div>