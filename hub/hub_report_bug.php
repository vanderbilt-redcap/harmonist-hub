...
<div>
    <div class="panel-collapse collapse in" aria-expanded="true">
        <div class="panel-body">
            <iframe class="commentsform" id="redcap-frame" message="R" src="<?=APP_PATH_WEBROOT_FULL.'/surveys/?s='.IEDEA_REPORTBUGSURVEY?>" style="border: none;height: 860px;width: 100%;"></iframe>
        </div>
    </div>
</div>