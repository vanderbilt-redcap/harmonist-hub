...
$back_button = '<a href="'.$module->getUrl('index.php').'&NOAUTH'.'">< Back to Home</a>';
...
if($_REQUEST['type'] != ""){
    if($_REQUEST['type'] == 'h'){
        ...
        $back_button = '<a href="'.$module->getUrl('index.php').'&NOAUTH&option=hub'.'">< Back to Requests</a>';
    }else if($_REQUEST['type'] == 'a'){
        $back_button = '<a href="'.$module->getUrl('index.php').'&NOAUTH&option=adm'.'">< Back to Admin</a>';
    }
}
?>
<script>
...
<div class="container">
    ...
    <div class="pull-right">
        <p><a href="<?=$module->getUrl('index.php').'&NOAUTH&option=mrr&type=a'?>">View Rejected & Deactivated Requests</a></p>
    </div>
    <?php }?>
