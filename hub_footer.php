...
<div class="footer">
    ...
    <div><a href="<?=$module->getUrl('index.php?NOAUTH&pid='.$pidsArray['PROJECTS'].'&option=abt')?>">About <?=$about['about_title']?></a> | <a href="mailto:<?=$settings['hub_contact_email']?>">Contact us</a> | <a href="<?=$module->getUrl('index.php?pid='.$pidsArray['PROJECTS'].'&option=bug')?>">Report a bug</a></div>
</div>