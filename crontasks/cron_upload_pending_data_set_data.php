...
require_once $module->getSafePath(
    "/app001/credentials/Harmonist-Hub/" . $pidsArray['PROJECTS'] . "_aws_s3.php",
    "/app001/credentials/Harmonist-Hub"
);
        ...
        if ($file_name_extension == 'json') {
            ...
            if ($uploadData != '') {
                ...
                if ($request_DU != "") {
                    ...
                    if (!$found) {
                        AllCrons::addUploadRecord($s3, $uploadData, $file_name, $bucket, $settings, "");
                    }
                } else {
