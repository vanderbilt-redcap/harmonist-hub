                    ...
                    if ($faq['help_category'] == $category_id) {
                        ...
                        if ($faq['help_image'] != '') {
                            ...
                            while ($row = $q->fetch_assoc()) {
                                echo '</br><div><img src="'.$module->getUrl('downloadFile.php?code='.\Vanderbilt\HarmonistHubExternalModule\getCrypt("sname=".$row['stored_name']."&file=". urlencode($row['doc_name']),'e',$secret_key,$secret_iv)) . '" style="display: block; margin: 0 auto;" alt="Image"></div>';
                            }
                        }
